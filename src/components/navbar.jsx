...
const Navbar = () => {
  return (
    <Dock className="fixed bottom-5 left-1/2 -translate-x-1/2 backdrop-blur-xl rounded-full shadow-md border border-white/30 px-2 bg-[#292929]\100 z-1">
      <DockIcon link={"#home"} className="transition-all delay-100 ease-in-out">
      ...
      <DockIcon link={"https://x.com/yashx024"} target={"_blank"}>
